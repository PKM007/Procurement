...
export class ViewComponent implements OnInit {
  ...
  //       }
        ...
        orderDecision(status, decision, refresher) {
          ...
          this.http.post('http://localhost/My Project/ionic2php/deleteOrderForeign.php', this.order).subscribe((data: any[]) => {
          this.order.multiLocs = this.multiLocs;
          this.order.finalItem = this.finalItem;
          this.order.action = 'update';
          console.log(data);
          this.http.post('http://localhost/My Project/ionic2php/orderDecision.php', this.order).subscribe((data: any) =>{
            console.log(data);
